...
L["BonusAgiStr"] = "Agi/Força aumentada"
L["BonusArmor"] = "Armadura aumentada"
L["BonusMana"] = "Mana aumentada"
L["BonusStamina"] = "Stamina aumentada"
L["BOTTOM"] = "botão" -- Needs review
L["BOTTOMLEFT"] = "botão esquerdo" -- Needs review
L["BurstHaste"] = "Heroismo/Sede de Sangue"
...
L["COLOR_COA_DESC"] = [=[Cor do ícone quando:

O relógio estiver ativo(inutilizável/presente),
%q estar desativado
%q estar definido por %q
]=] -- Needs review
L["COLOR_COLOR"] = "Cor" -- Needs review
L["COLOR_COS"] = "Cronômetro, Relógio escondido, às vezes mostrar" -- Needs review
L["COLOR_COS_DESC"] = [=[Cor do ícone quando:

O relógio estiver ativo(inutilizável/presente),
%q estar desativado
%q não estar definido por %q]=] -- Needs review
L["COLOR_CTA"] = "Cronômetro, Relógio visível , Sempre mostrar" -- Needs review
L["COLOR_CTA_DESC"] = [=[Cor do ícone quando:

O relógio estiver ativo(inutilizável/presente),
%q estar ativado
%q estar definido por %q]=] -- Needs review
L["COLOR_CTS"] = "Cronometro, relógio visível, as vezes mostrar" -- Needs review
L["COLOR_CTS_DESC"] = [=[Cor do ícone quando:
...
L["COLOR_NA_DESC"] = [=[O relógio estar terminado(utilizável/ausente),
%q estar  definido por %q]=] -- Needs review
L["COLOR_NS"] = "terminado, as vezes mostrar" -- Needs review
L["COLOR_NS_DESC"] = [=[O relógio estar terminado(utilizável/ausente),
%q não estar  definido por %q]=] -- Needs review
...
L["CONDITIONPANEL_UNIT_DESC"] = "Insira a unidade para assistir nesta caixa. A unidade pode ser inserida pelo dropdown na direita ou usuários avançados podem  digitar em suas próprias unidades. Unidades padrões (ex. jogadores) e/ou nomes de jogadores amigáveis (ex.%s) podem ser utilizadas como unidades." -- Needs review
L["CONDITIONPANEL_UNITDROPDOWN_DESC"] = "Você pode selecionar uma unidade para este menu para inserir-la dentro da caixa de edição. Unidades que terminam com '|cFFFF0000#|r' precisam que o '|cFFFF0000#|r' seja substituído por um número que correspondam para a unidade apropriada. Ex. Mudar 'raid|cFFFF0000#|r' para 'raid25' para sinalizar o 25º  membro da raid" -- Needs review
...
L["DROPDOWN_UNIT_DESC"] = "Você pode selecionar unidades para este menu para inseri-los na caixa de edição. Unidades que terminem com  '|cFFFF0000#|r' precisam que '|cFFFF0000#|r' seja substituído com um número que correspondam para a unidade apropriada ou um intervalo de números. Ex. Mudar 'raid|cFFFF0000#|r' para 'raid25' para rastreia o 25º membro da raid ou mudar ele para 'raid1-25' para rastreiar o primeiro membro da raid de 25." -- Needs review
L["DURATIONPANEL_TITLE"] = "Duração" -- Needs review
...
L["EVENTS_SETTINGS_GLOBAL_DESC"] = "Note que as configurações de eventos afetam todos os eventos em todas as saídas, incluindo som e texto." -- Needs review
...
L["EXPORT_SPECIALDESC"] = "Outros usuários do TellMeWhen podem apenas importar o grupos ou perfis inteiros tiverem a versão 4.6.0+." -- Needs review
...
L["HELP_ICD_NATURESGRACE"] = [=[Tentando listar o recarregamento de %s?
É recomendado que você mude o tipo de ícone para %q em vez disso, que irá listar o redefinimento no seu recarregamento desencadead por mudanças no estado eclipse.]=] -- Needs review
...
L["IncreasedPhysCrit"] = "Mayor probabilidad de golpe crítico físico"
L["IncreasedSpellCrit"] = "Mayor probabilidad de golpe crítico con hechizos"
...
L["NEWVERSION"] = "Uma  nova versão do Tell Me When estar disponível https://github.com/Xzanti0/Tellmewhen-3.3.5" -- Needs review
...
L["IncreasedArmorPercent"] = "Porcentagem de armadura aumentada"
L["DamageReduction"] = "Redução de dano aumentada"
L["IncreasedSP"] = "Maior poder mágico"
L["IncreasedSpirit"] = "Espírito aumentado"
L["IncreasedStatAdd"] = "Adição de estatísticas aumentada"
L["IncreasedStatPercent"] = "Porcentagem de estatísticas aumentada"
L["Replenishment"] = "Reabastecimento"
L["IncreasedAPPercent"] = "Porcentagem de Poder de Ataque Aumentada"

L["PhysicalDmgTaken"] = "Dano Físico Levado"
L["PushbackResistance"] = "Resistência à Tempo de Lançamento Perdido Aumentado" -- Needs review
...
L["SpellCritTaken"] = "Magia Crít. Recebida Aumentada" -- Needs review
L["CritTaken"] = "Aumento de los golpes críticos recibidos" --Needs review
L["SpellHitChance"] = "Mayor probabilidad de golpe de hechizo" --Needs review
